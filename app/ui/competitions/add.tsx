...
import { addCompetition, AddCompetitionState } from '@/app/lib/actions'
  ...
  return (
    <Box className='flex flex-col'>
      <form action={formAction}  aria-describedby="form-error">
        ...
        <FormControl>
          <InputLabel id="select-competition-type">Type</InputLabel>
        ...
        <div className="mt-6 flex justify-end gap-4">
          ...
          <Tooltip title="Add Competition"><Button variant="contained" startIcon={<SaveAsRounded />} color="primary">Add</Button></Tooltip>
        </div>
      </form>
    </Box>
  )
